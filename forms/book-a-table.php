<?php
  ...
  * The library should be uploaded to: vendor/js-email-form
/js-email-form
.php
  * For more info and help: https://bootstrapmade.com/js-email-form
/
  */
  ...
  if( file_exists($php_email_form = '../assets/vendor/js-email-form/js-email-form.php' )) {
